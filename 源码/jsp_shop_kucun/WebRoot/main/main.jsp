...
DBO db=new DBO();//��ʼ��������
String sql="select * from xtgg where 1=1 limit 0,5 ";//��ѯ ϵͳ����sql���
db.open();//�����ݿ�����
...
<style type="text/css">
* {padding: 0;margin: 0;font-family: "΢���ź�";font-size: 14px;}
...
<td class="td" width="10%"><a href="../xtgg/xtggdetail.jsp?keyid=<%=rs.getString("xtggid")%>">�鿴</a></td>
</tr>
</table>
</td>
</tr>
