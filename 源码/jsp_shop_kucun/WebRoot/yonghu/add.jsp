...
<br />
  ...
  <tr>
    <td height="30" background="../images/bg_list.gif"><div  style="padding-left:10px; font-weight:bold; color:#FFFFFF">ע���û�</div></td>
  </tr>
  <tr>
 ...
 <td colspan="2" class="td"><input name="zw" placeholder="����ְ��"  type="text" value="" /> </td>
   ...
   <tr onmouseover="style.backgroundColor='#EEEEEE'" onmouseout="style.backgroundColor='#F1F5F8'" bgcolor="#F1F5F8">
         ...
         <td colspan="2" class="td">
		  <input type="button" value="ע��" name="B1" class="btn" style="width:60px" onclick="checkDo()"  />
                      &nbsp;&nbsp;
                      <input type="button" value="����" style="width:60px" name="chanel" class="btn" onclick="window.history.go(-1)" />
