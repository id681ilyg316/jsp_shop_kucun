...
<td class="td" width="10%"><a href="xtggupdate.jsp?keyid=<%=rs.getString("xtggid")%>">�༭</a> |<a href="xtggdelete.jsp?keyid=<%=rs.getString("xtggid")%>"   onClick="javascript:if(confirm('�Ƿ�ɾ��')){return true;}else{return false;}">ɾ��</a>|<a href="xtggdetail.jsp?keyid=<%=rs.getString("xtggid")%>">�鿴</a></td>
</tr>
 ...
 <td align="right">��ǰҳ����[<%=Page%>/<%=maxPage%>]&nbsp;
	<%if(Page>1){%>
<a href="xtgglist.jsp?Page=1">��һҳ</a>��<a href="xtgglist.jsp?Page=<%=Page-1%>">��һҳ</a>
	<% }
if(Page<maxPage){%>
<a href="xtgglist.jsp?Page=<%=Page+1%>">��һҳ</a>��<a href="xtgglist.jsp?Page=<%=maxPage%>">���һҳ&nbsp;</a>
	<%}
