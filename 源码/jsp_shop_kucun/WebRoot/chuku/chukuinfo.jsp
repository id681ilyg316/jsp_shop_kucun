...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#666666">
  <tr>
   ...
   <tr>
    <td bgcolor="#FFFFFF">��Ʒ&nbsp;&nbsp;  <input type="text" name="sp" />&nbsp;&nbsp;�۸�&nbsp;&nbsp;  <input type="text" name="jg" />&nbsp;&nbsp;<input type=submit value="��ѯ">
	</td>
	</tr>
	</table>
...
<td class="td" width="10%"><a href="chukudetail.jsp?keyid=<%=rs.getString("ckid")%>">�鿴</a></td>
</tr>
</table>
</td>
</tr>
