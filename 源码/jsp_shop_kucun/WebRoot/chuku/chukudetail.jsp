...
DBO db=new DBO();//��ʼ�����ݿ�����
String   sp="",jg="",sl="",ms="",czr="",cksj="";//����ҳ����ʾ�ı���
String keyid=(String)request.getParameter("keyid");//��request��ʽ��ȡ ������Ϣ�� ����ֵ
String sql="select a.*,b.spmc from chuku a,shangpin b where a.sp=b.spid and a.ckid="+keyid;//ƴ��sql
ResultSet rs=null;//���������
db.open();//�����ݿ�����
...
*/
if(rs.next()){//����
 sp=rs.getString("spmc");//��Ʒ
jg=rs.getString("jg");//�۸�
sl=rs.getString("sl");//����
ms=rs.getString("ms");//����
czr=rs.getString("czr");//������
cksj=rs.getString("cksj");//����ʱ��
