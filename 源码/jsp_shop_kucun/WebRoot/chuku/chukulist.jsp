...
DBO db=new DBO();//��ʼ�������ݿ���
String sql="select a.*,b.spmc from chuku a,shangpin b where 1=1 and a.sp=b.spid ";//��ѯ ����sql���
db.open();//�����ݿ�����
...
<td class="td" width="10%"><a href="chukuupdate.jsp?keyid=<%=rs.getString("ckid")%>">�༭</a> |<a href="chukudelete.jsp?keyid=<%=rs.getString("ckid")%>"   onClick="javascript:if(confirm('�Ƿ�ɾ��')){return true;}else{return false;}">ɾ��</a>|<a href="chukudetail.jsp?keyid=<%=rs.getString("ckid")%>">�鿴</a></td>
</tr>
 ...
 <td align="right">��ǰҳ����[<%=Page%>/<%=maxPage%>]&nbsp;
	<%if(Page>1){%>
<a href="chukulist.jsp?Page=1">��һҳ</a>��<a href="chukulist.jsp?Page=<%=Page-1%>">��һҳ</a>
	<% }
if(Page<maxPage){%>
<a href="chukulist.jsp?Page=<%=Page+1%>">��һҳ</a>��<a href="chukulist.jsp?Page=<%=maxPage%>">���һҳ&nbsp;</a>
	<%}
