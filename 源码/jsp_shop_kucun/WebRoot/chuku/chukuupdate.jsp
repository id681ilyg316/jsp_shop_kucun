...
DBO db=new DBO();//���ݿ�����
String   sp="",jg="",sl="",ms="",czr="",cksj="";//��ʼ������
String keyid=(String)request.getParameter("keyid");//����
String sql="select * from chuku where ckid="+keyid;//�����ѯsql���
ResultSet rs=null;//�����ѯ�����
db.open();//�����ݿ�����
...
<form name="form" action="" >
  ...
  <tr>
    <td height="30" background="../images/bg_list.gif"><div  style="padding-left:10px; font-weight:bold; color:#FFFFFF">�޸ĳ���</div></td>
  </tr>
  <tr>
...
<td colspan="2" class="td" ><input type="text"  style="FONT-SIZE: 12px; WIDTH: 300px"  placeholder="�������ʱ��"  name=cksj value="<%=cksj%>"></td>
</tr>
